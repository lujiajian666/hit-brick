      ...
      const list = [
        ...Array(20).fill().map((_, indexY) => {
          return [
            ...
            { id: ++idCount, x: 30, y: indexY * 10, indestructible: false, show: true },
            { id: ++idCount, x: 40, y: indexY * 10, indestructible: false, show: true },
            { id: ++idCount, x: 50, y: indexY * 10, indestructible: false, show: true },
            { id: ++idCount, x: 60, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            ...
            { id: ++idCount, x: 140, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            ...
            { id: ++idCount, x: 220, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            { id: ++idCount, x: 230, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            { id: ++idCount, x: 240, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            { id: ++idCount, x: 250, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            { id: ++idCount, x: 260, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            ...
            { id: ++idCount, x: 330, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            { id: ++idCount, x: 340, y: indexY * 10, indestructible: false, show: true, prop: PROP_TYPE.FISSION },
            ...
            { id: ++idCount, x: 460, y: indexY * 10, indestructible: false, show: true },
